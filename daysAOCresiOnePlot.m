...
subplot(2,1,1);
plot(time_KBRX,ant_rate,'.k','LineWidth',2,'MarkerSize',2)
% hold on
...
axis([0 24 -10^(-6) 10^(-6)])
set(gca,'XTick',[0:2:24])
saveas(gcf,[filepathNeda,'plots/20',year,'/okresAOC_',itr,apriori,'_',year,ds,did],'png')
