...
filepathNeda='/storage/research/aiub_u_camp/NEDA/GEN/';
...
fieldi={'ACTTUG','ACCTUG'};%,'rl03const8','rl03const8nofilter'
%fieldi={'aiubApr8cons','aiubApr10s','aiubAprScloff','aiubApr','aiubApr03neq'};%,'rl03const8','rl03const8nofilter'
...
%% ITSG18
ggmITSG18 = readGFC([filepathITSG,fieldITSG,'-Grace2018_n96_20',year,'-',month{nom},'.gfc']);
ggmITSG18 = ggmITSG18(1:n_back,:); % cut to desired length
%if zero-tide
ggmITSG18(4,3)=ggmITSG18(4,3)+4.173e-9; % tide correction
%% ITSG16
% ggmITSG16 = readGFC([filepathITSG,fieldITSG,'-Grace2016_n90_20',year,'-',month{nom},'.gfc']);
% ggmITSG16 = ggmITSG16(1:n_back,:); % cut to desired length
% %if zero-tide
% ggmITSG16(4,3)=ggmITSG16(4,3)+4.173e-9; % tide correction
%% Goco
...
% d_vec_itsg18 = ggmGoco;
% d_vec_itsg18(:,3:4) = ggmGoco(:,3:4)-ggmITSG18(:,3:4);
% dv_geoidnc20(d_vec_itsg18,lmaxf,rGoco,[0 0 0]);
hold on
% d_vec_itsg16 = ggmGoco;
% d_vec_itsg16(:,3:4) = ggmGoco(:,3:4)-ggmITSG16(:,3:4);
% dv_geoidnc20(d_vec_itsg16,lmaxf,rGoco,[0 1 0]);
% hold on
...
ggmi= importGravityField([filepathNeda,'GRAV',fieldi{imod},'_',year,month{nom},'.GRV'],13,13+n_back);
...
%legend('ITSG18',fieldi{1},fieldi{2},'Location','southwest')%,'AIUBRL02','JPLRL06','GFZRL06','CSRRL06','GFZRL06'
legend('ACTfromTUG','ACTfromJPL','Location','best')%,'AIUBRL02','JPLRL06','GFZRL06','CSRRL06','GFZRL06'
saveas(gcf,[filepathNeda,'plots','/testACCdegvar',year,month{nom},'.png'])
%% plot triangles
